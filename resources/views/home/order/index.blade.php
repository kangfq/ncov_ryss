                ...
                <div class="col-md-4">
                    <div class="card" style="width: 92%; margin: 10px;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">共{{ $order['total_num'] }}件 ￥{{ $order['total_money'] }}</h6>
                            ...
                            @else
                                <span class="badge badge-danger" style="margin-right: 5px;font-size: 85%!important;">商家：{{ $order['mall']->name }}</span>
